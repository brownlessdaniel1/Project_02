...
def home():
    ...
    data = str(previous_records)

    return render_template("index.html", int_one=str(response_service_2), int_two=str(response_service_3), total= response_service_4, previous_records=data, version=os.getenv("VERSION"))
